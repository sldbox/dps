        ...
        <div class="notice-version-panels">
          <section class="notice-version-panel active" data-notice-version-panel="v105">
            ...
            <div class="notice-step-card"><h3>특성 프리셋 개선</h3><ul>
              ...
              <li>프리셋 업데이트를 누르면 현재 선택한 프리셋에는 지금 화면값이 저장됩니다.</li>
              <li>여러 프리셋에서 같이 써야 하는 값은 다른 프리셋에도 함께 맞춰집니다.</li>
              <li>총 SP, 난이도, 목표 라운드처럼 프리셋마다 달라야 하는 값은 현재 선택한 프리셋에만 저장됩니다.</li>
    ...
    'preset-guide': {
      ...
      html: `
        ...
        <div class="notice-step-card">
          ...
          <ul>
            <li>기본 정보: 총 SP, 난이도, 고행 단계, 목표 라운드, 도전의탑 층</li>
        ...
        <div class="notice-step-card">
          <h3>예시</h3>
          <ul>
            <li>A 프리셋에서 총 SP나 난이도만 바꾸고 업데이트하면 A 프리셋에만 저장됩니다.</li>
            <li>B, C, D 프리셋의 총 SP와 난이도는 기존 값 그대로 유지됩니다.</li>
            <li>모든 프리셋이 같이 써야 하는 일반 입력값을 바꾸면 다른 프리셋에도 함께 반영됩니다.</li>
          </ul>
        </div>
      `,
      actions: []
