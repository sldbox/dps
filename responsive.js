(() => {
  ...
  const MOBILE_PAGES = [
    ...
    { key: 'rune-effect', label: '룬효과/버프', selectors: ['.unit-enhance-card', '.two-panel-buff'] },
  ...
  function applyMode() {
    ...
    const deviceClass = w <= 600 ? 'is-mobile-device' : (w <= 1024 ? 'is-tablet-device' : '');
