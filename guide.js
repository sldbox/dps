(function(){
  ...
  const GUIDE_TABS=[
    ...
    {id:'backup',label:'저장복구',summary:[['현재값 저장','현재 브라우저에 입력 상태를 저장합니다. 같은 기기에서 다시 열 때 사용합니다.'],['입력값 백업','다른 기기에서 쓰거나 오류 제보할 때 백업 파일을 만듭니다.'],['최신 버전 확인','이번 배포 캐시 버전은 v=2606091600입니다. 화면이 이상하면 새로고침 후 이 버전으로 접속합니다.'],['오류 제보',errorText]],steps:[['01','현재값 저장','현재 입력 상태를 브라우저에 저장합니다.'],['02','백업 생성','입력값 백업을 눌러 파일로 저장합니다.'],['03','백업 복원','입력값 복원으로 저장했던 파일을 불러옵니다.'],['04','최신 파일 확인','화면이 이상하면 새 버전 주소로 접속하거나 브라우저 새로고침을 합니다.'],['05','제보 준비','계산이 다르면 엑셀 파일과 입력값 백업 파일을 함께 전달합니다.']]}
  ];
